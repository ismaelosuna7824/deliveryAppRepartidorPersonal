import 'package:TuGoRepartidor/src/pages/completeInformation.dart';
import 'package:TuGoRepartidor/src/pages/notifications.dart';
import 'package:TuGoRepartidor/src/pages/profile.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/CompleteInformation':
        return MaterialPageRoute(builder: (_) => CompleteInformationWidget());
      default:
